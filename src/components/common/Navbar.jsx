...
export const Navbar = () => { 
  ...
  return (
  <div>
    <nav className={cn("z-10 top-7 left-1/3 translate-x-25 fixed md:flex items-center gap-5 rounded-full py-2 px-4 backdrop-blur-md bg-black/20 text-black dark:bg-fuchsia-200 transition-all duration-300 border-zinc-500 hidden  ")}>
      ...
      <a href="/skills" className="hover:text-fuchsia-200 transition-colors duration-100 dark:hover:text-fuchsia-900 text-shadow-lg/20 text-shadow-fuchsia-200 dark:text-shadow-none">Skills</a>
      <a href="/projects" className="hover:text-fuchsia-200 transition-colors duration-100 dark:hover:text-fuchsia-900 text-shadow-lg/20 text-shadow-fuchsia-200 dark:text-shadow-none">Projects</a>
