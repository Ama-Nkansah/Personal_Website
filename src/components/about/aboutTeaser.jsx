...
export default function AboutTeaser({isFullPage = false,showButton = true }) {
  ...
  return (
    <div className="h-full justify-center bg-white dark:bg-[#2b3336] text-gray-900 dark:text-gray-100 p-2 pt-14">
      ...
      <h1 className= {`w-1/2 md:translate-x-50 sm:translate-x-30 text-3xl font-bold text-shadow-lg/20 text-shadow-fuchsia-400 ${isFullPage ? "translate-y-9" : ""}`}>About Me</h1>
