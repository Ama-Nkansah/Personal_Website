    ...
    <div>
      <div className="grid md:grid-cols-2 grid-rows-1 gap-5">
        ...
        <div className="grid grid-cols-1 grid-rows-4 gap-1 -ml-100 m-10">
          <h3 className="text-3xl text-fuchsia-300 ml-170 my-5 delius-regular">Projects</h3>
        ...
        <div className="grid grid-cols-1 grid-rows-4 gap-1 -ml-100 m-10">
          <h3 className="text-3xl text-fuchsia-300 ml-130 my-5 delius-regular">Professional Experience</h3>
